<aside class=" w-80 bg-base-200">
    ...
    <ul class="px-4 py-0 menu menu-sm lg:menu-md">
        ...
        <li><a href="{{ route('roles.index') }}" wire:navigate>Supplier</a></li>
    ...
    <ul class="px-4 py-0 menu menu-sm lg:menu-md">
        ...
        <li><a href="{{ route('roles.index') }}" wire:navigate>Produk</a></li>
    </ul>
    {{-- Transaksi --}}
    <ul class="px-4 py-0 menu menu-sm lg:menu-md">
        <li></li>
    ...
    <ul class="px-4 py-0 menu menu-sm lg:menu-md">
        ...
        <li><a href="{{ route('roles.index') }}" wire:navigate>Penjualan </a></li>
