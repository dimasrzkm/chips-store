<div>
    <x-alert />
    <x-breadcrumbs defaultSegment="Expenses" />
                ...
                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    ...
                    <tbody>
                        @forelse ($expenses as $index => $expense)
                            @foreach ($expense->stocks as $i => $item)
                                                    ...
                                                    <ul tabindex="0"
                                                        ...
                                                        <li>
                                                            ...
                                                            <a onclick="my_modal_1.showModal()"
                                                                wire:click="getDataForDelete({{ $expense }})"
    ...
    <dialog wire:ignore.self id="my_modal_1" class="modal">
        <form method="dialog" class="modal-box">
            <h3 class="text-lg font-bold">Menghapus Data Pengeluaran Stock!</h3>
            ...
            <div class="modal-action">
                <button class="btn btn-error" wire:click="deleteExpense()">Hapus
                </button>
