<div>
    <x-alert />
    <x-breadcrumbs defaultSegment="Roles And Permission" />
        ...
        <div
            ...
            <div class="flex flex-col items-center justify-between p-4 space-y-3 md:flex-row md:space-y-0 md:space-x-4">
                ...
                <div
                    ...
                    <a type="button" href="{{ route('assign.create') }}" wire:navigate
                    ...
                    <tbody>
                        @forelse ($users as $index => $user)
                            <tr class="border-b dark:border-gray-700">
                                ...
                                <td class="px-4 py-3"> {{ implode(', ', $user->getRoleNames()->toArray()) }}
                                </td>
